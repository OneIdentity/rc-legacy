...
/* ----------------------------------------------------------------------
 * Functions to access administrative policies
 */

/*
 * Policy functions return 1 if the policy has been defined and
 * the provided buffer has been filled, otherwise they return 0.
 */
