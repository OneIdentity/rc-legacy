...
#define WINHELP_CTX_connection_username_fromenv "connection.username.fromenv:config-username-fromenv"
#ifdef SSPI_MECH
#define WINHELP_CTX_ssh_auth_gssapi "ssh.auth.gssapi:config-ssh-auth-gssapi"
#define WINHELP_CTX_ssh_gssapi_server_determines_username "ssh.gssapi.server.determines.username:config-ssh-gssapi-server-determines-username"
#define WINHELP_CTX_ssh_auth_gssapi_fwd_ticket "ssh.auth.gssapi.fwd.ticket:config-ssh-auth-gssapi-fwd-ticket"
#define WINHELP_CTX_ssh_trust_dns "ssh.trust.dns:config-ssh-trust-dns"
#define WINHELP_CTX_ssh_auth_gssapi_prin_name "ssh.auth.gssapi.prin.name:config-ssh-auth-gssapi-prin-name"
#define WINHELP_CTX_ssh_kex_gss "ssh.kex.gss:config-ssh-kex-gss"
#endif
