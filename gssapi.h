 ...
 */
typedef struct pgss_ctx_id *gss_ctx_id_t;
typedef struct pgss_cred_id *gss_cred_id_t;
typedef struct pgss_name *gss_name_t;
...
#define GSS_KRB5_S_G_BAD_SERVICE_NAME           (_GSS_KRB5_BASE +  0)
/* "No @ in SERVICE-NAME name string" */
#define GSS_KRB5_S_G_BAD_STRING_UID             (_GSS_KRB5_BASE +  1)
/* "STRING-UID-NAME contains nondigits" */
#define GSS_KRB5_S_G_NOUSER                     (_GSS_KRB5_BASE +  2)
/* "UID does not resolve to username" */
#define GSS_KRB5_S_G_VALIDATE_FAILED            (_GSS_KRB5_BASE +  3)
/* "Validation error" */
#define GSS_KRB5_S_G_BUFFER_ALLOC               (_GSS_KRB5_BASE +  4)
/* "Couldn't allocate gss_buffer_t data" */
#define GSS_KRB5_S_G_BAD_MSG_CTX                (_GSS_KRB5_BASE +  5)
/* "Message context invalid" */
#define GSS_KRB5_S_G_WRONG_SIZE                 (_GSS_KRB5_BASE +  6)
/* "Buffer is the wrong size" */
#define GSS_KRB5_S_G_BAD_USAGE                  (_GSS_KRB5_BASE +  7)
/* "Credential usage type is unknown" */
#define GSS_KRB5_S_G_UNKNOWN_QOP                (_GSS_KRB5_BASE +  8)
/* "Unknown quality of protection specified" */

/* 4.1.2. Kerberos-specific-codes */

#define GSS_KRB5_S_KG_CCACHE_NOMATCH            (_GSS_KRB5_BASE +  9)
/* "Principal in credential cache does not match desired name" */
#define GSS_KRB5_S_KG_KEYTAB_NOMATCH            (_GSS_KRB5_BASE + 10)
/* "No principal in keytab matches desired name" */
#define GSS_KRB5_S_KG_TGT_MISSING               (_GSS_KRB5_BASE + 11)
/* "Credential cache has no TGT" */
#define GSS_KRB5_S_KG_NO_SUBKEY                 (_GSS_KRB5_BASE + 12)
/* "Authenticator has no subkey" */
#define GSS_KRB5_S_KG_CONTEXT_ESTABLISHED       (_GSS_KRB5_BASE + 13)
/* "Context is already fully established" */
#define GSS_KRB5_S_KG_BAD_SIGN_TYPE             (_GSS_KRB5_BASE + 14)
/* "Unknown signature type in token" */
#define GSS_KRB5_S_KG_BAD_LENGTH                (_GSS_KRB5_BASE + 15)
/* "Invalid field length in token" */
#define GSS_KRB5_S_KG_CTX_INCOMPLETE            (_GSS_KRB5_BASE + 16)
/* "Attempt to use incomplete security context" */

#if !defined(_GSS_STRICT) || _GSS_EXTENDED_MECH_INQUIRY >= 2
/* extended-mech-inquiry-02.txt */
